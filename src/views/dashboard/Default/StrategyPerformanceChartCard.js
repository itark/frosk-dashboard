...
const ser = {
    series: [
        {
            data: [0, 15, 10, 50, 30, 40, 25, 55, 87, 120]
        }
    ]
};
...
const StrategyPerformanceChartCard = () => {
    ...
    useEffect(() => {
        ApexCharts.exec(`support-chart`, 'updateSeries', ser.series);
    }, []);
...
export default StrategyPerformanceChartCard;
